/// DEPRECATED: Этот файл содержит старые ViewModels на базе ChangeNotifier.
/// Новые контроллеры находятся в папке controllers/.
///
/// Статус миграции:
/// - LoginViewModel -> ✅ МИГРИРОВАН на LoginController (controllers/login_controller.dart)
/// - RegisterViewModel -> ✅ МИГРИРОВАН на RegisterController (controllers/register_controller.dart)
/// - AuthLoadingViewModel -> ⏳ ОЖИДАЕТ миграции
library;
    ...
    _ref.listen(authNotifierProvider, (previous, next) {
      next.whenOrNull(
        ...
        error: (error, stackTrace) {
          AppLogger.error(
            'Auth error in AuthLoadingViewModel',
            error,
            stackTrace,
          );
